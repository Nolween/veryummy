    ...
    <div>
        ...
        <div class="px-4 divide-y-4 divide-dotted divide-gray-200">
            <div class="flex mb-3 flex-wrap justify-center">
                <div class="w-full sm:w-1/2 lg:w-1/3"><img class="w-full max-h-80 object-cover rounded-2xl mb-2"
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 my-auto">
                    <p class="h-full px-4 text-veryummy-primary text-5xl md:text-7xl w-full text-center ">EXPLORER DE
                        NOUVELLES RECETTES</p>
                </div>
            </div>
            <div class="pt-4 flex flex-wrap justify-center">
                <div class="w-full sm:w-1/2  lg:w-1/3 my-auto">
                    <p class="h-full px-4 text-veryummy-primary text-5xl md:text-7xl w-full text-center ">MES RECETTES</p>
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3"><img class="w-full max-h-80 object-cover rounded-2xl mb-2"
