...
<body class="antialiased">
                ...
                <div class="w-4/5 lg:w-2/5 xl:w-7/12 mb-3 px-4 mx-auto" id="photo-div">
                    <label for="photo-input">
                        <img class="w-full h-full max-h-full object-cover rounded-sm mb-2 cursor-pointer" id="photo"
                            src="{{ asset('storage/img/full/ajout-photo.png') }}" alt="test">
                    </label>
    ...
    <script>
        ...
        autocomplete(document.getElementById("ingredient0"), ingredients, 0, {{ Illuminate\Support\Js::from(route('new-ingredient.create')) }});
    </script>
</body>
