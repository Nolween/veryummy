...
<body class="antialiased">
    <div>
        ...
        <form action="{{ route('my-recipes.create') }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            {{-- Nom de la recette --}}
            ...
            <div class="flex flex-wrap justify-center mb-5">
                ...
                <div class="w-4/5 lg:w-2/5 xl:w-5/12 my-auto">
                    ...
                    <div class="flex flex-wrap mb-3 px-4 justify-center items-center">
                        ...
                        <div class="my-auto">
                            <input type="number" name="making" min="0" step="1"
                    ...
                    <div class="flex flex-wrap mb-8 px-4 justify-center">
                        ...
                        <div class="my-auto">
                            <input type="number" name="cooking" min="0" step="1"
                                class="caret-gray-400 border-gray-100 border-2 text-4xl w-24 pl-4 mx-3 rounded-sm focus:border-gray-400 focus:outline-none">
                            <span class="text-gray-400 text-5xl">MINUTES</span>
                        </div>
                    </div>
            ...
            <div id="ingredients" class=" divide-y-4 divide-dotted divide-gray-400 divide">
                <div class="w-full xl:w-3/4 flex flex-wrap my-4 px-4 mx-auto justify-center " id="ingredientInputs0">
                    ...
                    <div class="autocomplete">
                        <input type="hidden" name="ingredients[0][ingredientId]" value="0" id="ingredientId0">
                    ...
                    <div class="text-center">
                        ...
                        <button type="button" class="bg-gray-400 text-4xl p-2 rounded-sm disabled align-middle ml-2">
                            <x-fas-trash-alt class="text-white h-5 w-5" />
                        </button>
                    </div>
                </div>
